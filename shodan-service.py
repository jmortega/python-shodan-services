...
'''
Notas:
Para utilizar Shodan es necesario contar con una developer key asociada a una cuenta.
Se pueden aplicar diferentes tipos de filtros, ver la referencia: http://www.shodanhq.com/help/filters
'''
...
if __name__ == "__main__":
    ...
    print("Shodan Key Info.\n")
    shodanSearch.shodanKeyInfo()
    print("------------------------------\n")
    #print("Searching for OpenSSL v1.0.1.\n")
    #shodanSearch.shodanSimpleSearch("OpenSSL 1.0.1")
    print("Searching for OpenSSL v1.0.1.\n")
